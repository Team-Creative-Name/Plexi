...
public class PlexiBotSingleton {

    //globals

    //reference to PlexiBotSingleton obj
    private static PlexiBotSingleton botObj = null;
    //reference to plexi object
    private JDA botInstance = null;


    //lock the constructor
    private PlexiBotSingleton() {

    }

    //static methods
    public static PlexiBotSingleton getInstance() {
        //if there is no plexi obj, create one.
        if (botObj == null) {
            botObj = new PlexiBotSingleton();
        }
